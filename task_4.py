...
print()
print('Вариант 1')
name_v1 = input('Введите имя: ')
surname_v1 = input('Введите фамилию: ')
print('Вас зовут')
print(name_v1)
print(surname_v1)
...
print()
print('Вариант 2')
name_v2 = input('Введите имя: ')
surname_v2 = input('Введите фамилию: ')
city_v2 = input('Введите город проживания: ')
print('==========')
print('Вас зовут',name_v2,surname_v2)
print('Вы живёте в городе',city_v2)